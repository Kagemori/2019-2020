...
#include "gdimage.h"
#ifdef _OPENMP
   //   ADD CODE what should get included here?
#include <omp.h>
#endif
...
#ifdef _OPENMP
    // ADD CODE set a start for a timer
	start_time = omp_get_wtime();
#endif
// ADD CODE set a pragma statement to parallelize the loop
...
#ifdef _OPENMP
    //  ADD CODE set a stop timer and print elapsed time
